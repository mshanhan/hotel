	...
	<div class="container">
						...
						<li class="span1_of_1">
							...
							<div class="section_room">
								<select id="country" onchange="change_country(this.value)" class="frm-field required">
									...
									<option value="null">单人间</option>
									<option value="AX">海景房</option>
									<option value="AX">双人间</option>
								</select>
							</div>
						</li>
		...
		<div class="grids_of_3">
			<div class="grid1_of_3">
				...
				<h4><a href="#">单人间<span>120$</span></a></h4>
			...
			<div class="grid1_of_3">
				...
				<h4><a href="#">单人间<span>180$</span></a></h4>
				<p>出门在外主管比较困难要不要找个人暖床.</p>
			</div>
			<div class="grid1_of_3">
				<div class="grid1_of_3_img">
				...
				<h4><a href="#">单人间<span>210$</span></a></h4>
				<p>出门在外主管比较困难要不要找个人暖床.</p>
			</div>
			<div class="grid1_of_3">
				<div class="grid1_of_3_img">
