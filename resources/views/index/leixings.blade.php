	...
	<div class="container">
		<div class="room-main">
			<div class="room-content">
				<div class="room" >
					<h4><a class="hover-img" href="rooms">豪华房间</a></h4>
				...
				<div class="room">
					<h4><a class="hover-img" href="rooms">海景房间</a></h4>
					<p class="para">Lorem Ipsum的段落有许多变化，但是大多数都会通过注入幽默或者看起来不太可信的随机单词进行某种形式的改变。如果你打算使用一段Lorem Ipsum，你需要确保在文本中间没有隐藏任何尴尬。互联网上的所有Lorem Ipsum生成器都会重复出现.</p>
				</div>
				<div class="grids_of_2">
					<div class="grids_of_img">
				...
				<div class="room">
					<h4><a class="hover-img" href="rooms">总统套房</a></h4>
					<p class="para">Lorem Ipsum的段落有许多变化，但是大多数都会通过注入幽默或者看起来不太可信的随机单词进行某种形式的改变。如果你打算使用一段Lorem Ipsum，你需要确保在文本中间没有隐藏任何尴尬。互联网上的所有Lorem Ipsum生成器都会重复出现.</p>
				</div>
				<div class="grids_of_2">
					<div class="grids_of_img">
				...
				<div class="room">
					<h4><a class="hover-img" href="rooms">大床房</a></h4>
					<p class="para">Lorem Ipsum的段落有许多变化，但是大多数都会通过注入幽默或者看起来不太可信的随机单词进行某种形式的改变。如果你打算使用一段Lorem Ipsum，你需要确保在文本中间没有隐藏任何尴尬。互联网上的所有Lorem Ipsum生成器都会重复出现.</p>
				</div>
				<div class="grids_of_2">
					<div class="grids_of_img">
				...
				<div class="room">
					<h4><a class="hover-img" href="rooms">单人床房间</a></h4>
					<p class="para">Lorem Ipsum的段落有许多变化，但是大多数都会通过注入幽默或者看起来不太可信的随机单词进行某种形式的改变。如果你打算使用一段Lorem Ipsum，你需要确保在文本中间没有隐藏任何尴尬。互联网上的所有Lorem Ipsum生成器都会重复出现.</p>
				</div>
				<div class="grids_of_2">
					<div class="grids_of_img">
				...
				<div class="room">
					<h4><a class="hover-img" href="rooms">双人床房间</a></h4>
					<p class="para">Lorem Ipsum的段落有许多变化，但是大多数都会通过注入幽默或者看起来不太可信的随机单词进行某种形式的改变。如果你打算使用一段Lorem Ipsum，你需要确保在文本中间没有隐藏任何尴尬。互联网上的所有Lorem Ipsum生成器都会重复出现.</p>
				</div>
				<div class="grids_of_2">
					<div class="grids_of_img">
			...
			<div class="sidebar">
				<div class="date_btn">
					<h4 type="submit" style="width: 82px;">房间设施</h4>
				</div>
